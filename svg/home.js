...
export function HomeSvg({ height, width }) {
    return (
        <Svg width={width} height={height} viewBox="0 0 36 36" aria-hidden="true" role="img" class="iconify iconify--twemoji" preserveAspectRatio="xMidYMid meet">
